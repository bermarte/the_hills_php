...
<div class="container vertical-center">
    ...
    <form action="" method="post" class="was-validated start">
                <div class="form-group col-sm text-center">
                    ...
                    <div class="btn-group">
                        <input type="submit" name="register_again" value="register" class="btn btn-primary" formnovalidate>
                        <input type="submit" name="enter_login_again" value="login again" class="btn btn-primary">
                    </div>
                </div>
    </form>
